...
**Status:** scaffolded — see [`native/Cargo.toml`](../Cargo.toml). First open decision (PRD Section 14): build fully from scratch, or on top of an existing minimal microkernel (e.g. seL4) to de-risk the timeline? Resolve this before writing boot code.
